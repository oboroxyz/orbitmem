...
const L = [
  ...
  { id: "transport", name: "Transport", tech: "ERC-8128", color: "#7C4DFF", icon: "⇌",
    desc: "Every agent HTTP request is cryptographically signed. Supports ECDSA, Ed25519, and P256/WebAuthn. Relay verifies without shared secrets.",
    apis: ["createSignedRequest()", "verifyOrigin()", "attachSessionProof()"] },
