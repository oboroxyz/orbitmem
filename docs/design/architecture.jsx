...
const L = [
  ...
  },
  {
    ...
    apis: [
      "vault.put('travel/dietary', val, {visibility})",
      "vault.get('travel')",
      "vault.insert(obj)",
      "vault.all()",
    ],
  ...
  },
  {
    ...
    apis: [
      "pricing.setPrice(path, {amount, currency})",
      "pricing.getPrice(path)",
      "pricing.listPrices()",
    ],
  },
  {
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <header
        style={{ padding: "28px 32px 20px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}
      >
        <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
          <span
            style={{
              ...
              background: "linear-gradient(135deg, #00E5FF, #448AFF, #7C4DFF)",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: "10px 18px",
                  border: "none",
                  background: on ? `${l.color}0C` : "transparent",
                  borderLeft: `2px solid ${on ? l.color : "transparent"}`,
                  cursor: "pointer",
                  textAlign: "left",
                }}
              >
                ...
                <div>
                  <div
                    style={{
                      fontSize: 12.5,
                      fontWeight: 600,
                      color: on ? l.color : "rgba(255,255,255,0.65)",
                    }}
                  >
                    {l.name}
                  </div>
          ...
          {a && (
            <div key={a.id}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                ...
                <div>
                  <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: a.color }}>
                    {a.name}
                  </h2>
                  <div
                    style={{
                ...
                {a.apis.map((api, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "3px 0",
                      borderBottom:
                        i < a.apis.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
                    }}
                  >
                    {api}
                  </div>
